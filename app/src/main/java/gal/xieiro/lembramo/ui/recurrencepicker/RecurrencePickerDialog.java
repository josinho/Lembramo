...
public class RecurrencePickerDialog extends DialogFragment implements OnItemSelectedListener,
    ...
    private static class RecurrenceModel implements Parcelable {
        ...
        static final int FREQ_HOURLY = 0;   //añadido
    ...
    private static final int[] mFreqModelToEventRecurrence = {
            EventRecurrence.HOURLY,    //añadido
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mModel.endDate == null) {
            ...
            switch (mModel.freq) {
                case RecurrenceModel.FREQ_HOURLY:  //añadido
    ...
    public void onClick(View v) {
        if (mEndDateTextView == v) {
            ...
            mDatePickerDialog = new DatePickerDialog(
                    RecurrencePickerDialog.this.getActivity(),
                    RecurrencePickerDialog.this,
                    mModel.endDate.year,
                    mModel.endDate.month,
